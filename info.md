...
|**HHCCPOT002**|FlowerPot, RoPot, broadcasts moisture and conductivity, 2 readings per minute, no battery info with firmware v1.2.6.|![HHCCPOT002](https://raw.githubusercontent.com/custom-components/ble_monitor/master/pictures/HHCCPOT002.jpg)|
|**WX08ZM**|Xiaomi Mija Mosquito Repellent, Smart version, broadcasts switch state, tablet resource, battery level, about 50 messages per minute.|![WX08ZM](https://raw.githubusercontent.com/custom-components/ble_monitor/master/pictures/WX08ZM.jpg)
...
|**V-SK152**|Viomi Smart Kettle, experimental support, collecting data, `ext_state` attribute as in YM-K1501, data broadcasted every 30 seconds.|![V-SK152](https://raw.githubusercontent.com/custom-components/ble_monitor/master/pictures/V-SK152.png)|
|**SJWS01LM**|Xiaomi Smart Water Leak Sensor. Broadcasts moisture state (wet/dry), advertisements are encrypted, therefore you need to set the key in your configuration, see for instructions the [encryption_key](#encryption_key) option.|![SJWS01LM](https://raw.githubusercontent.com/custom-components/ble_monitor/master/pictures/SJWS01LM.png)|
