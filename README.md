...
|**XMTZC01HM, XMTZC04HM**|**Mi Smart Scale 1 / Mi Smart Scale 2**<br /><br />Broadcasts `weight` and `weight removed`. Weight is only reported after the scale is stabilized.|![XMTZC05HM](/pictures/XMTZC04HM.png)|
|**XMTZC02HM, XMTZC05HM, NUN4049CN**|**Mi Body Composition Scale 2 / Mi Body Fat Scale**<br /><br />Broadcasts `weight`, `impedance` and `weight removed`. Weight is only reported after the scale is stabilized.|![XMTZC05HM](/pictures/XMTZC05HM.png)|
