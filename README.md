...
|**YM-K1501**|**Xiaomi Mijia Smart kettle**<br /><br />Eperimental support, collecting data. The switch entity has an extra `ext_state` attribute, with the following values: `0` - kettle is idle, `1` - kettle is heating water, `2` - warming function is active with boiling, `3` - warming function is active without boiling.|![YM-K1501](/pictures/YM-K1501.png)|
|**V-SK152**|**Viomi Smart Kettle**<br /><br />Experimental support, collecting data, `ext_state` attribute as in YM-K1501, data broadcasted every 30 seconds.|![V-SK152](/pictures/V-SK152.png)|
...
|**XMTZC02HM, XMTZC05HM, NUN4049CN**|**Mi Body Composition Scale 2 / Mi Smart Scale 2 / Mi Body Fat Scale**<br /><br />Broadcasts `weight`, `impedance` and `load removed`. Weight is only reported after the scale is stabilized.|![XMTZC05HM](/pictures/XMTZC05HM.png)|
